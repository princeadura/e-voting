                    ...
                    <?php foreach ($teams as $index => $team) { ?>
                        <li class="team-item">
                            <div class="team-member">
                                <img src="/assets/images/<?= $team["img"] ?>" class="team-member-img" alt="member image">
                                <div class="team-member-overlay">
                                    <div class="item">
                                        <a href="<?= $team["link_w"] ?>" class="icon" aria-label="whatsapp">
                                            <i class="fab fa-whatsapp" aria-hidden="true"></i>
                                            <p class="tip">
                                                WhatsApp
                                            </p>
                                        </a>
                                        <a href="<?= $team["link_f"] ?>" class="icon" aria-label="whatsapp">
                                            <i class="fab fa-twitter" aria-hidden="true"></i>
                                            <p class="tip">
                                                Twitter
                                            </p>
                                        </a>
                                        <a href="<?= $team["link_t"] ?>" class="icon" aria-label="whatsapp">
                                ...
                                <div class="label">
                                    <h2 class="name"><?= $team["name"] ?><a href="#" class="link-primary"> <i class="fab fa-linkedin" aria-hidden="true"></i> </a></h2>
                                    <h5 class="role"> <?= $team["role"] ?> </h5>
                                </div>
                            </div>
                        </li>
                    <?php } ?>
